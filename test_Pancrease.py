...
parser.add_argument('--root_path', type=str, default='/nas/cv/wyx/OURS/Pancreas/', help='Name of Experiment')  # todo change dataset path
parser.add_argument('--model', type=str,  default="Pancrease-20%", help='model_name')                # todo change test model name
parser.add_argument('--gpu', type=str,  default='0', help='GPU to use')
FLAGS = parser.parse_args()

os.environ['CUDA_VISIBLE_DEVICES'] = FLAGS.gpu
snapshot_path = "../model/"+FLAGS.model+'/'
test_save_path = "/home/lab/OURS/MCF-Net-fft/model/prediction/"+FLAGS.model+"_post/"
